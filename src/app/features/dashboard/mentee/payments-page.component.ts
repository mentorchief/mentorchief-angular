  ...
  template: `
    <div class="p-6 lg:p-8">
      ...
      <div class="flex items-start gap-3 p-4 bg-accent/50 border border-primary/10 rounded-md mb-8">
        ...
        <div class="text-sm">
          <p class="text-foreground font-medium mb-1">How payments work on MentorChief</p>
          <p class="text-muted-foreground text-xs">
            When you subscribe to a mentor, your payment is held in escrow &mdash; not sent directly. This protects you during the mentorship. Funds are only released to your mentor once the subscription period completes. You can cancel within the first 3 days for a full refund.
          </p>
        </div>
      </div>
