...
export class MenteeMessagesPageComponent {
  ...
  selectConversation(conv: Conversation): void {
    ...
    this.messages = [
      { id: 1, senderId: 'mentor', text: 'Hi! How are you doing with the project?', timestamp: '2:15 PM' },
      { id: 2, senderId: 'me', text: 'Going well! I finished the first module.', timestamp: '2:20 PM' },
      { id: 3, senderId: 'mentor', text: 'Great progress on your project! Let\'s discuss next steps.', timestamp: '2:30 PM' },
    ];
  }
